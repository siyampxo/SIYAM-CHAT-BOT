...
module.exports.run = async function({ api, event }) {
  ...
  const botName = global.config.BOTNAME || "𝐒𝐈𝐘𝐀𝐌 𝗖𝗵𝗮𝘁 𝗕𝗼𝘁";
...
★ যেকোনো অভিযোগ অথবা হেল্প এর জন্য এডমিন 𝐒𝐈𝐘𝐀𝐌 কে নক করতে পারেন ★
➤𝐌𝐞𝐬𝐬𝐞𝐧𝐠𝐞𝐫: https://m.me/100063442824450
➤𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩: https://wa.me/01789963078
❖⋆═══════════════════════⋆❖
          𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 ➢ 𝐒𝐈𝐘𝐀𝐌
      if (selected) {
